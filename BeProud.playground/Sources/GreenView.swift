...
public class GreenView: UIViewController {
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = grayScale.soft
        self.setupPerson()
        self.paintMe()
    ...
    func setupAcceptance() {
        self.acceptanceView.backgroundColor = UIColor(red:0.47, green:0.84, blue:0.44, alpha:1.0)
    ...
    @objc func tapToNext() {
        ...
        blueView.preferredContentSize = CGSize(width: 700, height: 450)
        self.present(blueView, animated: true)
    }
}
