...
public class PurpleView: UIViewController {
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = grayScale.lighter
        self.setupCircle()
        self.paintMe()
    ...
    func setUpAcceptance() {
        self.acceptanceView.backgroundColor = UIColor(red:0.58, green:0.15, blue:0.65, alpha:1.0)
    ...
    @objc func tapToNext() {
        ...
        finalView.preferredContentSize = CGSize(width: 700, height: 450)
        self.present(finalView, animated: true)
    }
}
