...
public class YellowView: UIViewController {
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = grayScale.normal
        self.setupPerson()
        self.paintMe()
    ...
    func setupAcceptance() {
        self.acceptanceView.backgroundColor = UIColor(red:1.00, green:0.99, blue:0.35, alpha:1.0)
    ...
    @objc func tapToNext() {
        ...
        greenView.preferredContentSize = CGSize(width: 700, height: 450)
        self.present(greenView, animated: true)
    }
}
